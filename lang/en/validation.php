...
return [
    ...
    | versiones, como las reglas de tamaño. Siéntete libre de ajustar cada uno de estos mensajes aquí.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para reemplazar nuestros marcadores de atributos
    | con algo más legible, como "Dirección de correo electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer que nuestro mensaje sea más expresivo.
    |
    */
